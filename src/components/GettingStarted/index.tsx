  ...
  return (
    <div>
      ...
      <Section>
        ...
        <span>
          Your app can interact with any of them using the same API. CSPR.click
          takes care of everything wallet related. If needed, you can{" "}
          <a
            href={
              "https://docs.cspr.click/core-js-sdk/types#csprclickinitoptions"
            }
            target={"_blank"}
            rel="noreferrer"
          >
      ...
      <Section>
        <span>
          CSPR.click UI components provide a common UX across different Casper
          apps for an easy management of accounts, settings, and future
          ecosystem-wide functionality.
        </span>
        <span>
          <a
          ...
          according to your application requirements. Add and remove settings
          selectors.
        </span>
      </Section>
      ...
      <Section>
        <span>
          Now, go back to the top of the page and sign in with your favorite
          wallet. Or, click here:
          <b
            onClick={(event) => {
